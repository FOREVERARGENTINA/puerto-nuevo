  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Si se debe crear evento, crearlo ahora
            ...
            <div className="section-warm mt-xl">
              ...
              {formData.createEvent && (
                <div style={{ paddingLeft: 'var(--spacing-lg)' }}>
                  <div className="form-group">
                    <label htmlFor="eventoTitulo" className="form-label">
                      Título del Evento *
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="events-form-row">
                    <div className="form-group">
                      <label htmlFor="eventoFecha" className="form-label">
                        Fecha del Evento *
                      </label>
                      <input
                        type="date"
                    ...
                    <div className="form-group">
                      <label htmlFor="eventoHora" className="form-label">
                        Hora (opcional)
                      </label>
                      <input
                        type="time"
                  ...
                  <div className="form-group">
                    <label htmlFor="eventoDescripcion" className="form-label">
