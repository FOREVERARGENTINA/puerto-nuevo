...
export function MyTallerEspecial() {
  ...
  if (loading) return (<div className="container" style={{ paddingTop: 'var(--spacing-xl)' }}><div className="card"><div className="card__body"><p>Cargando...</p></div></div></div>);
  if (!talleres || talleres.length === 0) return (<div className="container" style={{ paddingTop: 'var(--spacing-xl)' }}><div className="card"><div className="card__header"><h1 className="card__title">Mis Talleres</h1></div><div className="card__body"><div className="alert alert--warning"><strong>No tienes talleres asignados</strong><p>Contacta con la dirección para que te asignen uno o más talleres.</p></div><button onClick={() => navigate(-1)} className="btn btn--outline" style={{ marginTop: 'var(--spacing-md)' }}>Volver</button></div></div></div>);
  ...
  return (
    <div className="container" style={{ paddingTop: 'var(--spacing-xl)' }}>
      <div className="card">
        <div className="card__header"><h1 className="card__title">Mis Talleres</h1><button onClick={() => navigate(-1)} className="btn btn--sm btn--outline">Volver</button></div>
